...
namespace MyCoreLib.Common.Helper
{
    ...
    {
        #region  Get 12-bit 39-digit Html string
        /// <summary>
        /// Get 12-bit 39-digit Html string
        /// </summary>
        ...
        public static string Get39Html(string s, int width, int height)
        {
            ...
            catch { return "unacceptable character!"; }
        ...
        #region Get the EAN13 code Html string
        /// <summary>
        /// Get the EAN13 code Html string
        /// </summary>
        /// <param name="s">string</param>
        /// <param name="width">barcode width</param>
        /// <param name="height">barcode height</param>
