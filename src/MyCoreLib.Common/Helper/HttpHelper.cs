...
{/// <summary>
 ...
 /// </summary>
    public class HttpHelper
    {
        ...
        public HttpHelper(bool randomAgent = true)
        {
            _headers.Clear();
            //随机一个useragent
            if (randomAgent)
        ...
        {
            return await HttpGetAsync(url, url);
        }
        ...
        /// <param name="refer"></param>
        /// <returns></returns>
        public async Task<string> HttpGetAsync(string url, string refer)
        {
            string html;
            try
            {
        ...
        /// <param name="url"></param>
        /// <returns></returns>
        public async Task<byte[]> HttpGetMineAsync(string url)
        {
            byte[] mine = null;
            try
            {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public async Task<string> HttpPostAsync(string url, string data)
        {
            return await HttpPostAsync(url, data, url);
        }
        /// <summary>
        /// 发送POST请求
        /// </summary>
        ...
        /// <param name="refer"></param>
        /// <returns></returns>
        public async Task<string> HttpPostAsync(string url, string data, string refer)
        {
            string html;
            try
            {
